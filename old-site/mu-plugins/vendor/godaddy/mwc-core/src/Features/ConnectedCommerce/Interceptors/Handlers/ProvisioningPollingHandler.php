...
/**
 * Ensures a recurring provisioning check action is scheduled while provisioning is pending.
 */
class ProvisioningPollingHandler extends AbstractInterceptorHandler
{
    ...
    /**
     * Schedules the recurring polling action if not already scheduled.
     */
    protected function maybeSchedulePolling() : void
    {
        $pollingJob = Schedule::recurringAction()
