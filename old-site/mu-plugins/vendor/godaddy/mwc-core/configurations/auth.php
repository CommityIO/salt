...
use GoDaddy\WordPress\MWC\Core\Auth\Sso\WordPress\JWT\ManagedWooCommerce\Token;
...
return [
    'godaddy' => [
        'mwc' => [
            'api' => [
                'tokenRefreshJobDateInterval' => 'PT45M',
            ],
        ],
    ],
    /*
    ...
    'jwt' => [
        ...
        'mwc_sso' => [
            ...
            'algorithm'       => 'RS256',
            'keySetProvider'  => KeySetProvider::class,
